...
<body>
    <div class="container">
        <h1><a href='homepage.php'><span class='glyphicon glyphicon-arrow-left'></span></a> | คำสั่งแต่งตั้ง | <a href='document_new.php'><span class='glyphicon glyphicon-plus'></span></a></h1>
        ...
        $sql = "SELECT *
                FROM documents
                WHERE concat(doc_num , doc_file_name) LIKE ? 
                ORDER BY doc_num";
